...
Bowerbird will maintain a local collection of data files, sourced from external data providers. When one does an analysis using such files,
it is useful to know *which* files were used, and the *provenance* of those files. This information will assist in making analyses reproducible.
