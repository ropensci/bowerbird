...
This [blog post (2018-11-13)](https://ropensci.org/blog/2018/11/13/antarctic/) illustrates setting up bowerbird from scratch and using it to obtain and work with several disparate data sets that overlap in space and time. 
