...
On Windows you can try the `install_wget()` function or download it yourself (e.g. from https://eternallybored.org/misc/wget/current/wget.exe) and make sure it is on your path.
