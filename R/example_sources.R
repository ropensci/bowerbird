...
bb_example_sources <- function() {
    bind_rows(
        ...
        bb_source2(
            ...
            method=quote(bb_handler_wget2),
            method_flags=list(recursive=TRUE,level=3,no_parent=TRUE),
        ...
        bb_source2(
            ...
            license="Please cite",
            method=quote(bb_handler_oceandata2),
            method_flags=list(search="S*L3m_MO_CHL_chlor_a_9km.nc"),
            postprocess=NULL,
            collection_size=7.2,
        ...
        bb_source2(
            ...
            method=quote(bb_handler_earthdata2),
            method_flags=list(recursive=TRUE,level=4,no_parent=TRUE,relative=TRUE),
            user="",
            password="",
            postprocess=NULL,
        ...
        bb_source2(
            ...
            method=quote(bb_handler_wget2),
            method_flags=list(recursive=TRUE,level=2,accept_regex="/netcdf/",reject="index.html*"),
