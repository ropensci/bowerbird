sources_sst <- function() {
    bb_source(
        name="NOAA Optimum Interpolation 1/4 Degree Daily Sea Surface Temperature Analysis AVHRR",
        ...
        bind_rows(
            bb_source(
                name="NOAA Optimum Interpolation Sea Surface Temperature V2",
        ...
        bind_rows(
            bb_source(
                name="NOAA Extended Reconstructed Sea Surface Temperature V3b",
        ...
        bind_rows(
            bb_source(
                name="Oceandata MODIS Terra Level-3 mapped monthly 9km sea surface temperature",
        ...
        bind_rows(
            bb_source(
                name="GHRSST Level 4 MUR Global Foundation Sea Surface Temperature Analysis (v4.1) (GDS versions 1 and 2)",
